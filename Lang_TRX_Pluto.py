...
class Lang_TRX_Pluto(gr.top_block):
    ...
    def __init__(self):
        ...
        self.logpwrfft_x_0 = logpwrfft.logpwrfft_c(
            ...
            average=True,
            shift=False)
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32(plutoip, [True, True], 0x8000)
        ...
        self.connect((self.iio_pluto_source_0, 0), (self.pano_keep, 0))
        self.connect((self.pano_keep, 0), (self.logpwrfft_pano, 0))
